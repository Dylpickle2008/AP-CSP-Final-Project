...
let answerList = ['Song', 'Industrial', 'Black', 'Safavid', 'Mongols', 'Safavid', 'France', 'Nationalism', 'Meiji', 'Otto Von Bismarck', 'Cecil Rhodes', 'Khamer', 'World']
let score = 0;
let questionIndex = 0;
...
function endGame (points) {
    if(questionIndex > 12){
        scoreContainer.textContent = "Final Score: /13" + points; 
